...
HD_PWD='C:/Users/Lenovo/Desktop/proj2/HDL-Coder-Self-Guided-Tutorial-master/pulse_detector/work/hdl_prj/vivado_prj/Pulse_Detector_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Pulse_Detector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Pulse_Detector.tcl -notrace
