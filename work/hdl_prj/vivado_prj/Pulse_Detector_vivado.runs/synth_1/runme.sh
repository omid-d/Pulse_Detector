...
HD_PWD='C:/Users/Lenovo/Desktop/proj2/HDL-Coder-Self-Guided-Tutorial-master/pulse_detector/work/hdl_prj/vivado_prj/Pulse_Detector_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pulse_Detector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pulse_Detector.tcl
